...
class SuppliersRepository extends ServiceEntityRepository
{
    ...
    public function findAllSuppliers(){
        ...
        ->createQuery(
            'SELECT suppliers.id, suppliers.name, suppliers.email, suppliers.phoneNumber, suppliers.type, suppliers.active, suppliers.date_create, suppliers.date_update
            FROM App:Suppliers suppliers'
        )
        ->getResult();
